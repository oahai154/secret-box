<script lang="ts">
  import { ipc, type Item, type Version } from "./ipc";
...
<div class="main-view">
  <header class="topbar">
    ...
    <div class="topbar-actions">
      ...
      <button id="settingsBtn" class="btn btn-ghost btn-sm" title="设置">
        <svg
          width="14"
          height="14"
          viewBox="0 0 24 24"
          ...
          {#key currentId}
            <div class="editor-card">
              <div class="editor-row">
                ...
                <input id="itemTitle" type="text" placeholder="例:GitHub 密钥" bind:value={detail.title} />
              </div>
